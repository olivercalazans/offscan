...
func (f *flooder) sendPingEndlessly() {
...
func (f *flooder) getPingPacket(builder *pktbuilder.IcmpPkt) []byte {
    srcMAC := f.srcMAC
	if srcMAC == nil {
	...
	return builder.L2Pkt(srcMAC, srcIP, f.dstMAC, f.dstIP)
}
...
func (dd *Dot11Dissector) GetAddrs() (models.MAC, models.MAC, bool) {
    var addr1, addr2 models.MAC
...
func (dd *Dot11Dissector) getAddr1() models.MAC {
	var addr models.MAC
...
func (dd *Dot11Dissector) getAddr2() models.MAC {
	var addr models.MAC
...
func isValid(mac models.MAC) bool {
	// Multicast IPv4
